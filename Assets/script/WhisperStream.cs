...
//public delegate void OnStreamSegmentUpdatedDelegate(String segment);
//public delegate void OnStreamSegmentFinishedDelegate(string segment);
...
//    public WhisperStream(WhisperStreamParams param,
...
//        if (_isStreaming)
//        {
//            Debug.Log("Stream is already working!");
//            return;
//        }
//        _isStreaming = true;
...
//        if (!_isStreaming)
//        {
//            Debug.Log("Start streaming first!");
//            return;
//        }
...
//        {
//            Debug.Log($"Stream finished an old segment with total steps of {_step}");
...
//        else
//        {
//            Debug.Log("Stream continues current segment");
//            // swap buffers
//            _oldBuffer = buffer;
//        }
//    }
